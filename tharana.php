...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp19.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Tharana</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name: Tarenna asiatica</p>
							<p>Family name:	RUBIACEAE</p><p> Local name: Tharana (තරණ)</p>
                            <p>Shrub or small tree to 10 m. leaves elliptic to elliptic-oblong, or oblanceolate, (6 -) 10 – 15 X (1 -) 3 – 4 (-5) cm, coriaceous, usually drying brown, above and below glabrous, apex acute, base acute to truncate. Inflorescence up to 6 cm long, 
                            usually minutely pubescent. Fruit 5 mm diameter, calyx remnants not long persistant.</p>
                            <p>Edible parts: None  </p> <p>Status: Native</p>
                            <p>PARTS  USED  IN  TREATMENT: Leaves, Immature stem buds, Roots, Stem barks</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Wounds and edema, Orthopedic lesions, Myagia, Lower abdominal pain, Acute skin cuts, Syphilis</p>
