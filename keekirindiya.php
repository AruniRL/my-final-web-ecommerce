...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp16.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Keekirindiya</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name: Eclipta prostrata</p>
							<p>Family name:	ASTERACEAE</p><p> Local name: Keekirindiya (කීකිරිඳිය) / Sindu kirindi (සිඳු-කිරිඳි)</p><p> English name: False Daisy</p><p> Sanskrit name:	Bhrungaraja, Bhrunga, Bhrungaja, Bhrungaraka, Bhrungara, Markava, Kesharaja, Keshranjana.</p>
                            <p>Annual herb. Stems reddish, 5- 45 cm long, often rooting at the nodes, stiffly appressed pilose. Leaves elliptic- lanceolate, 0.75- 5.5 cm X 1.5- 15 mm, attenuate and subpetiolate at the base, narrowly acute at the apex, margin entire or
                             faintly serrate, stiffy appressed pilose on both surfaces. Ray flowers numerous, white. Disc flowers 10- 15, white. Pappus scales c. 0.25 mm long.</p>
                            <p>Edible parts: None </p> <p>Status: Native</p>
                            <p>PARTS  USED  IN  TREATMENT:  Entire plant</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Alopecia, Oedema, Cough, Gastritis</p> 
                  </div>
                </div>
              </div>
                  ...
                  <p class="name">OTHERS </p>
                    <span class="position"></span>
                    <p class="mb-5 pl-4 line">RELATED   MEDICINAL PROPERTIES:   Analgesic</p>
