      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread">What Kind of Plants Do You Like....</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">How To Grow Your Plants.....</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
            <h4><a href="dieseases.php">Diseases</a></h4>
            <h4><a href="uses.php">uses of herbs plants</a></h4>
            <h4><a href="plantsmap.php"> Herbs Plants map In sri lanka</a></h4>
