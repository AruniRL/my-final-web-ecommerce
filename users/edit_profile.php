...
?>
  ...
  if(isset($_POST['edit_profile'])){
    ...
    if($_POST['name'] !='' && $_POST['edit_country'] !='' && $_POST['city'] !='' && $_POST['contact'] !='' &&  $_POST['address']) {
       ...
       $update_profile = mysqli_query($con, "update user_s set name ='$name',country ='$country', city='$city', contact='$contact', user_address='$address' where id='$_SESSION[user_id]'");

       if($update_profile){
           echo "<script>alert('your update was successfuly')</script>";
