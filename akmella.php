...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp5.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Akmella plants</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name: Spilanthes paniculata</p>
							<p>Family name:	ASTERACEAE</p><p> Local name: Akmella (අක්මැල්ල)</p>
                            <p>Annual herb. Stems subglabrous or very sparsely pubescent, eventually attaining about 40 cm tall. Leaves ovate, lamina 2- 9 X 1-7 cm acute or obtuse at the tip, margin undulate serrate, sparsely pubescent on the lower surface. Ray flowers absent, disc flowers 2 mm long, yellow, 4-5 lobed. Achenes narrowly obovate, c. 2 mm long, 1mm broad, black, very sparsely puberulous near the apex,. Pappus bristles 1- 1.25 mm long.</p>
                            <p>Edible parts:None  </p> <p>Status: Native</p>
                            <p>PARTS  USED  IN  TREATMENT: Flowers, Roots, Whole plant</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Toothache, Oedema, Tonsillitis, Skin diseases, Wounds, Diarrhoea, Snake bites, Rheumatism, Headache </p>
                  ...
                  <p class="name"> OTHER </p>
                    <span class="position"></span>
                    <p class="mb-5 pl-4 line">RELATED   MEDICINAL PROPERTIES: Antimicrobial, Diuretic</p>
