...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp6.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Asamodagam plants</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name: Trachyspermum involucratum</p>
							<p>Family name:	APIACEAE</p><p> Local name: Asamodagam (අසමෝදගම්)</p>
                            <p></p>
                            <p>Edible parts: Leaves and Young stems  </p> <p>Status: Only under cultivation</p>
                            <p>PARTS  USED  IN  TREATMENT: Seeds</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Coughs, Asthma, Hiccough, Dysentery </p>
                  ...
                  <p class="name"> OTHER </p>
                    <span class="position"></span>
                    <p class="mb-5 pl-4 line">RELATED   MEDICINAL PROPERTIES: Aphrodisia, Pacifies kapha dosas</p>
