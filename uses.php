...
<html lang="en">
  ...
  <body class="goto-here">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">yourplantsandseeds@gmail.com</span>
					    </div>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/bg_7.jpeg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Herbs Plants</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
            <h4><a href="iramusu.php">Iramusu plant</a></h4>
            <h4><a href="aba.php">Aba plant</a></h4>
            <h4><a href="adathoda.php">Adathoda plant</a></h4>
            <h4><a href="ahu.php">Ahu plant</a></h4>
              <h3><a href="akkapana.php">Akkapana palnt</a></h3>
              <h3><a href="akmella.php">Akmella plant</a></h3>
              <h3><a href="aloevera.php">Aloevera plant</a></h3>
              <h3><a href="alupuhul.php">Alupuhul plant</a></h3>
              <h3><a href="andu.php">Andu plant</a></h3>
              <h3><a href="aralu.php">Aralu Plant</a></h3>
              <h3><a href="asamodagam.php">Asamodagam plant</a></h3>
              <h3><a href="ashoka.php">Ashoka plant</a></h3>
