...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/cbg-1.jpg');">
      <div class="container">
      ...
      <div class="container">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Address:</span> 27/1 Old Road,Kollupitiya , Colombo 03, Sri Lanka</p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Phone:</span> <a href="tel://+ 9411 688 4210">+ 9411 688 4210</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Email:</span> <a href="mailto:yourplantsandseeds@email.com">yourplantsandseeds@</a></p><p>gmail.com</p>
	          </div>
	          </div>

          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Website:Plants And Seeds Home</span> <a href="Plants And Seeds Home"></a></p>
	          </div>
          </div>
        </div>
        <div class="row block-9">
          <div class="col-md-6 order-md-last d-flex">
            <form action="inqudb.php" method="post" class="bg-white p-5 contact-form">
              ...
              <div class="form-group">
                <input type="submit" value="Submit Inquiry" class="btn btn-primary py-3 px-5">
              </div>
            </form>
            ...
            function initMap(){
             ...
             // var map = new
              ...
              var infowindow = new google.maps.InfoWindow({
                content: '<p>27/1 Old Road,<br> Kollupitiya,<br> Colombo 03,<br> Sri Lanka</p>'
              });
