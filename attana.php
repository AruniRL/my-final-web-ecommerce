...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp12.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Attana</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name: Datura metel</p>
							<p>Family name:	SOLANACEAE</p><p> Local name: Attana (අත්තන) / Kalu-attana (කළු-අත්තන)</p><p> Sanskrit name:	Dhattura, Dhastura, Unmatta, Shivapriya, Harapriya, Hema,Dhustura,Kanaka</p>
                            <p>Erect, rounded, soft stemmed shrub, up to 1(-2) m tall. Leaves entire or angular in outline, up to 29 cm long, 16 cm broad; petioles 1/3-1/2 as long as blade. Flowers erect, solitary in axils; corolla about 15 cm long, creamy white or streaked with red or mauve.
                             Fruit a spherical capsule covered with stout tubercles or prickles. Seeds brown, 5 mm diameter.</p>
                            <p>Edible parts: None </p> <p>Status: Native</p>
                            <p>PARTS  USED  IN  TREATMENT:  Roots, Leaves, Seeds</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Swellings, Rheumatism, Lumbago, Tumours, Cataract, Eye diseases, 
                    Asthma, Toothache, Dog bites, Hydrophobia, Hydrocele, Severe colds, Tuberculosis, Insanity, Abscesses, Sciatica, Dysmenorrhoea, General pains, Rabies, Filariasis</p> 
                  </div>
                </div>
              </div>
                  ...
                  <p class="name"> OTHERS</p>
                    <span class="position"></span>
                    <p class="mb-5 pl-4 line"> RELATED   MEDICINAL PROPERTIES: Antispasmodic, Anodyne, Narcotic</p>
