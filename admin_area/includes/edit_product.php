...
<td ><textarea name="product_desc" cols="65" rows="20"><?php $fetch_edit['product_desc']; ?></textarea></td>
</tr>
<tr >
    <td></td>
...
if(isset($_POST['edit_product'])){
    ...
    $update_product = mysqli_query($con, "update products set product_cat='$product_cat', product_title='$product_title', product_price='$product_price',product_desc='$product_desc', product_image='$product_image', date='$date' where product_id='$_GET[product_id]'");


    }

    }else{
        $update_product = mysqli_query($con, "update products set product_cat='$product_cat', product_title='$product_title', product_price='$product_price',product_desc='$product_desc',  date='$date' where product_id='$_GET[product_id]'");
    }
    if($update_product){
