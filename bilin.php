...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp13.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Bilin</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name: Averrhoa bilimbi</p>
							<p>Family name:	OXALIDACEAE</p><p> Local name: Bilin (බිලිං)</p><p> English name:	Bilimbi</p>
                            <p>Small tree, 3-10 m tall; young parts and petioles velvety with soft rusty brown hairs. Leaves with 11-35 pinnae; the lower pinnae 1.2-3 x 0.6-2.2 cm, the upper 3-10 x 2-4 cm, pubscent; petiole 2-6 cm long, enlarged at the base; rachis 4-40 cm; petiolules 3-8 mm long, tomentose. Inflorescences 2-15 cm long, mainly cauliflorus. Flowers in fascicles; petals dark red-purple. Berry fleshy, 4-6 cm long, about 2.5 cm broad, with 5 blunt longitudinal ridges or terete, 
                            greenish yellow when ripe, very acidic. Seeds mostly 2-5 in each loculus, white, 6-8 mm long.</p>
                            <p>Edible parts: Fruit  </p> <p>Status: Only under cultivation</p>
                            <p>PARTS  USED  IN  TREATMENT: Leaves, Fruits</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Rectal inflammation, Mumps, Rheumatism, Acne, Fevers, Haemorrhage from bowels, stomach, Haemorrhoids </p>
