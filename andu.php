...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp14.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Andu</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name: Eryngium foetidum</p>
							<p>Family name:	APIACEAE</p><p> Local name: Andu (අඳු)</p><p> English name:	Long coriander / Sea Holly</p>
                            <p></p>
                            <p>Edible parts:None  </p> <p>Status: Native</p>
                            <p>PARTS  USED  IN  TREATMENT:  Roots, Leaves</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Insanity, Skin Diseases, Mucosal diseases, Diabetes mellitus, Paralysis, Epilepsy, Convulsions, Spasms, Pulmonary ailments, Pains, Stomach disorders </p>
                  ...
                  <p class="name"> OTHER </p>
                    <span class="position"></span>
                    <p class="mb-5 pl-4 line">RELATED   MEDICINAL PROPERTIES: Febrifuge, Vermifuge</p>
