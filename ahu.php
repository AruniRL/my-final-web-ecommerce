...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp8.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Ahu plants</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name: Morinda citrifolia</p>
							<p>Family name:	RUBIACEAE</p><p> Local name: Ahu (අහු)</p><p> English name: Indian mulberry</p><p> Sanskrit name:	Aachchaka</p>
                            <p>Shrub or small tree with stout branchlets marked with leaf scars, Leaves simple, elliptic to broadly elliptic, upto15-20 cm long, Petiole upto 3 cm, Inflorescence a solitary, ovoid, axillary capitulum, Flowers regular, bisexual, white, 5-merous, Corolla tube 8-12 mm long, corolla lobes oblong, 3-6mm long, ovary inferior, Syncarp (fruit) large, fleshy, 3-10 cm diam.</p>
                            <p>Edible parts: Roots, leaves, tender leaves,bark and fruits </p> <p>Status: Native</p>
                            <p>PARTS  USED  IN  TREATMENT: Roots, Leaves, Tender leaves, Bark, Fruitss</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Gout, Cysts, Wounds, Amenorrhoea, Fevers, Dysentery</p>
                  ...
                  <p class="name"> OTHER </p>
                    <span class="position"></span>
                    <p class="mb-5 pl-4 line">RELATED  MEDICINAL PROPERTIES: Purgative, Reduces aggravation of pitha dosha, Rattapitta nashaka</p>
