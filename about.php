      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Every Thing You Wanted To Know About Plants And Seeds Home</a></span> <span></span></p>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Welcome to Plants And Seeds Home</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p> You don’t need lots of space, lots of money, or secret knowledge. We hope that we can inspire people to garden, for growing plants.</p>
