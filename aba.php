...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp4.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Aba plants</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name:	Brassica juncea</p>
							<p>Family name:	COMBRETACEAE</p><p>English name: Mustard</p><p> Local name: Aba(අබ)</p><p>Sanskrit name: Sarshapa / Siddharta / Rajika</p>
                            <p>Perennial herb, usually grown as an annual or biennial, up to 1 m or more tall. Lower leaves petioled, green, variously lobed with toothed, scalloped or frilled edges, lyrate-pinnatisect, with 1–2 lobes or leaflets on each side and a larger sparsely setose, terminal lobe; upper leaves subentire, 30–60 mm long, 2–3.5 mm wide, constricted at intervals, sessile. Flowers bright yellow. Fruit a green, sickle shaped pod</p>
                            <p>Edible parts:Seed  </p> <p>Status: Naturalized Exotic</p>
                            <p>PARTS  USED  IN  TREATMENT: Leaves, Seeds, Root</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Lung infections, Thyroid Diseases, Paediatrics Diseases </p>
