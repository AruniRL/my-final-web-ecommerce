...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp9.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Ashoka / Diya rathambala</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name: Saraca asoca</p>
							<p>Family name:	FABACEAE</p><p> Local name: Ashoka (අශෝක) / Diya rathambala (දිය රතඹලා)</p><p> English name: Ashoka tree</p><p> Sanskrit name:	Ashoka</p>
                            <p>Trees to about 9 m tall. Leaves with (1 -) 4 – 6 pairs of leaflets, subsessile; leaflets subcoriaceous, oblong to lanceolate, 3.5 – 25 X 1 – 9 cm, acute to acuminate at the apex, 
                            acute to rounded, rarely cordate at the base, glabrous on both surfaces. Inflorescence compact corymbose panicles, axillary and terminal. Fruit elliptic to oblong, glabrous, 4 – 8 seeded. Seeds ovoid, compressed.</p>
                            <p>Edible parts: None </p> <p>Status: Native</p>
                            <p>PARTS  USED  IN  TREATMENT: Bark</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Menorrhagia, Disuria, Diarrhoea, Dysentery</p>
                  ...
                  <p class="name"> OTHER </p>
                    <span class="position"></span>
                    <p class="mb-5 pl-4 line">RELATED  MEDICINAL PROPERTIES: Astringent, Purifies raktha dhatu</p>
