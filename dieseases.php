...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/di.webp);">
	          ...
	          <div class="pb-md-5">
            <h4><a href="aster_yellows.php">aster yellows..</a></h4>
            <h4><a href="aba.php">bacterial wilt</a></h4>
            <h4><a href="adathoda.php">blight. fire blight. rice bacterial blight</a></h4>
            <h4><a href="ahu.php">canker</a></h4>
              <h3><a href="akkapana.php">crown gall</a></h3>
              <h3><a href="akmella.php">rot. basal rot</a></h3>
              <h3><a href="aloevera.php">scab.</a></h3>
