...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp21.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Komarika plants</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name:	Kalanchoe laciniata</p>
							<p>Family name:	CRASSULACEAE</p><p>English name:Aloe vera</p><p> Local name:Komarika </p>
