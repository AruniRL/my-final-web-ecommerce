...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp10.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Adathoda / Agaladara / Wanepala / Wetahera</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name: Justicia adhathoda</p>
							<p>Family name:	ACANTHACEAE</p><p> Local name: Adathoda (ආඩතෝඩා)/ Agaladara (අගල් ආධාර) / Wanepala (වනැපල) / Wetahera (වැටහිර)</p><p> English name: Malabar Nut</p><p> Sanskrit name:	Vasa</p>
                            <p>Shrub upto 4m high, Leaves oval elliptic, 11-28X4-10 cm, opposite, Petiole 0.8–3.6 cm long, Spikes terminal and axillary, unbranched, Bracts oval oblong, upto 2.4X1.2 cm, 3-nerved from base, Calyx lobes lenear-oblong, Corolla white,
                             broadly tubular, Stemens 2, epipetalous, Anthers green, 2-celled, Overy superior, 2-locular, Capsule obovoid.</p>
                            <p>Edible parts: None </p> <p>Status: Native</p>
                            <p>PARTS  USED  IN  TREATMENT: Roots, Leaves, Flowers, Bark, Stem</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Coughs, Asthma, Tuberculosis, Swellings, Eczema, Fevers, Menorrhagia, Dysentery, Urinary tract problems,Gastritis, Nausea</p> 
                  </div>
                </div>
              </div>
                  ...
                  <p class="name"> OTHER </p>
                    <span class="position"></span>
                    <p class="mb-5 pl-4 line">RELATED  MEDICINAL PROPERTIES: Stops Internal Bleeding, Helps to keep heart healthy</p>
