...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp7.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Alu puhul plants</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name: Benincasa hispida</p>
							<p>Family name:	CUCURBITACEAE</p><p> Local name: Alu puhul (අළු පුහුල්)</p><p> English name: White gourd</p><p> Sanskrit name:	Kushmanda</p>
                            <p>A large trailing or climbing plant with stout , hispid stems; tendrils 2-fid. Leaves 10-25 cm in diameter, reniform, cordate, more or less 5-lobed, hispids beneath; petioles7.5-10 cm long without glands. Flowers large, yellow, monoecious, solitary. Fruits 30-45 cm long, broadly cylindric, not ribbed, hairy, ultimately covered with a waxy bloom; seeds many.</p>
                            <p>Edible parts: fruits </p> <p>Status: Only under cultivation</p>
                            <p>PARTS  USED  IN  TREATMENT: Root, Stem, Fruit, Flower, Seeds, Leaves</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Malnutrition, Burn wound, Excessive thirst, Worm diseases, Gastritis, Haemorrhoids, Dysurea, Urinary tract infections</p>
                  ...
                  <p class="name"> OTHER </p>
                    <span class="position"></span>
                    <p class="mb-5 pl-4 line">RELATED   MEDICINAL PROPERTIES: Stimulate weight gain, Keeps the heart healthy,Enhance memory and brain functions</p>
