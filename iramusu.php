...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp15.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Iramusu</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name:	Hemidesmus indicus</p>
							<p>Family name:	PERIPLOCACEAE</p><p>English name: Indian sarsparilla</p><p> Local name: Iramusu (ඉරමුසු)</p><p>Sanskrit name: SharibaAnantmula, Gopi, Gopa, Gopakanya, Gopavalli, Gopasuta, Krishodari, Sphota, Utpalasarivaa, Kapuri, Dugdhgarbha</p>
                            <p>It is a slender, laticiferous, prostrate, twining herb, or sometimes semi-erect shrub; roots woody and aromatic; stems numerous, slender, terete, thickened at the nodes. Leaves opposite,
                             short-petiolated, very variable, elliptic-oblong to linear-lanceolate. Inflorescences cymes. Flowers axillary, greenish outside, purplish inside. </p>
                            <p>Edible parts:Leaves </p> <p>Status: Native</p>
                            <p>PARTS  USED  IN  TREATMENT: Whole plant is used</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Oedeama, Skin rashes, Coughs, Asthma, Piles </p>
                  ...
                  <p class="name">OTHER </p>
                    <span class="position"></span>
                    <p class="mb-5 pl-4 line">RELATED  MEDICINAL  PROPERTIES: Purifies blood, Body coolant, Appetizer, Reduces aggravation of vatha , pitha and kapha dosha</p>
