...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.php">PLANTS AND SEEDS HOME</a>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp20.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Saffron</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name: Crocus sativus</p>
							<p>Family name:	Iridaceae</p><p> Local name: Kunkuma (කුන්කුම) </p>
                            <p>A labour-intensive crop, the three stigmas are handpicked from each flower, spread on trays, and dried over charcoal fires for use as a food flavouring and colouring. A pound (0.45 kilogram) of saffron represents 75,000 blossoms. Saffron contains 0.5 to 1 percent essential oil, 
                            the principal component of which is picrocrocin. The colouring matter is crocin.</p>
                            <p>Edible parts: Flowers  </p> <p></p>
                            <p>PARTS  USED  IN  TREATMENT: Flowers</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Cough, Asthma, Baldness,Pain, Insomnia, Stomach gas </p>
