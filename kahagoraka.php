...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp17.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Ela goraka/  Kaha goraka</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Scientific name: Garcinia zeylanica</p>
							<p>Family name:	CLUSIACEAE</p><p> Local name: Ela goraka (එළ ගොරකා) / Kaha goraka (කහ ගොරකා)</p>
                            <p>Tree, up to 20 m tall, glabrous. Bark dark brown, fissured. Leaves sub-coriaceous; 1.5 x 6-4 x 10 cm; petioles 1-1.5 cm long.
                             Male flowers in the axils of upper leaves, pedicels up to 1-2.5 cm long; female flowers solitary. Fruit like a large apple, up to 8 cm diameter, glossy pale yellow, persistent sepals reflexed under the fruit. Seeds embedded in a soft juicy sweet-acid arillode</p>
                            <p>Edible parts: Fruit  </p> <p>Status: Endemic</p>
                            <p>PARTS  USED  IN  TREATMENT: Leaves, Bark, Flowers, Fruits</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Ulcers, Rheumatism, Bowel problems, Anorexia, Chronic dyspepsia, Fractures </p>
                  ...
                  <p class="name"> OTHER </p>
                    <span class="position"></span>
                    <p class="mb-5 pl-4 line">RELATED   MEDICINAL PROPERTIES: Antiseptic, Veterinary medicine, Purgative</p>
