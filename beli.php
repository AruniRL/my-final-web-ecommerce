...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp11.jpg);">
	          ...
	          <div class="pb-md-5">
	          	<p>Scientific name: Aegle marmelos</p>
							<p>Family name:	RUTACEAE</p><p> Local name: Beli (බෙලි)</p><p> English name: Bael fruit</p>
                            <p>Small deciduous tree, to 10 m tall, the older branches spiny, the spines single or paired,, 1-2 cm long. New branches green, slightly zig-zag. Leaves alternate, trifoliate or 1 or 2 leaflets; petiole 2-4 cm long; petiolules 1-3 mm long. Leaflets 7 x 4.2 cm , the terminal 7.5 x 4.8 cm, pale or mid green. Inflorescences axillary, to 4-5 cm long, clustered, flowers in racems. Petals white, glandular. Fruits subglobose, wih a hard woody shell, 8-16 (or 20) segments, 
                            with usually 6-10 seeds in a clear, sticky, edible pulp. Seeds woody-pubescent, testa white.</p>
                            <p>Edible parts: Fruits and flowers </p> <p>Status: Only under cultivation</p>
                            <p>PARTS  USED  IN  TREATMENT: Flowers, Roots, Leaves, Fruits</p> 
                  ...
                  <div class="text text-center">
                    ...
                    <p class="mb-5 pl-4 line"> Treatment for- Dysentery, Excessive thirst, Nausea, Piles, Fevers, Body odour, Nervous system diseases, Headache, Constipation</p> 
                  </div>
                </div>
              </div>
