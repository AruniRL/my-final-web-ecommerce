    	...
    	<div class="container">
    		...
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images//seeds/carrots.jpg" >
    						<span class="status"></span>
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Carrot Seeds</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/seeds/tomato.jpg" >
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Tomato Seeds</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/seeds/beetroot.jpg" >
	    					<div class="overlay"></div>
	    				</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">BeetRoot Seeds</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/seeds/radish.jpg" >
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Radish Seeds</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>LKR 20.00</span></p>
		    					</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/seeds/cabbage.jpg" >
    						<span class="status"></span>
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Cabbage Seeds</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc"></span><span class="price-sale">LKR 200.00</span></p>
		    					</div>
	    					</div>
	    					<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/seeds/ridge.jpg" >
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Ridge Gourd Seeds</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>LKR 20.00</span></p>
		    					</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/seeds/cherry.jpg" >
	    					<div class="overlay"></div>
	    				</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Cherry seeds</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>LKR 30.00</span></p>
		    					</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/seeds/beans.jpg" >
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Beans seeds</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>LKR 20.00</span></p>
		    					</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/seeds/redbeans.gif" >
    						<span class="status"></span>
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Red Bean seeds</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc"></span><span class="price-sale">LKR 20.00</span></p>
		    					</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/seeds/winter.jpg" >
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Winter Melon Seeds</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>LKR 20.00</span></p>
		    					</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/seeds/bell.jpg" >
	    					<div class="overlay"></div>
	    				</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Bell Pepper Seeds</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>LKR 20.00</span></p>
		    					</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/seeds/pumpkin.jpg" >
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Pumpkin Seeds</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>LKR 20.00</span></p>
		    					</div>
