...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/herbs/pp1.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Turmeric plants</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Turmeric has been used in India for more than 5000 years now. Initially, it was cultivated as a dye as its’ vivid yellow color works brilliantly as a coloring agent. Then its highly developed uses came to know and people started using it for cosmetic and beautification purposes and eventually as a medicine.  Later it became popular as a spice</p>
							<p>It’s also about the plants and seeds. Diversity is at the heart of plenty, and with nearly 500 different varieties of vegetable, herb and flower seeds on offer, we believe that our range will have something special for everyone.
              We have allocated much of our space to the plants and plants native to Sri Lanka.</p>
                  ...
                  <div class="text text-center">
                    ...
                    <p class="name">About our plants and seeds</p>
                    <p class="mb-5 pl-4 line">we have quality plants and seeds store. The safety and environmental impacts of genetically engineered seed are still unknown. Genetically engineered seeds or GMO’s as they are known have no place in the home vegetable garden. </p>
                  ...
                  <div class="text text-center">
                  <p class="name">our packaging </p>
                    <span class="position"></span>
                    <p class="mb-5 pl-4 line">Our packing team carefully selects, labels, packs and tapes your plants and seeds in place so they reach you in the best condition possible. They're all specially hydrated before they leave the nursery.</p>
